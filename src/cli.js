...
if (require.main === module) {
  program
    ...
    .option('--app-bundle-id <value>', 'Bundle ID from Apple Developer console (defaults to com.electron.name)')
    .option('--app-version <value>', 'App Version')
    .option('--build-version <value>', 'Build Version')
    .option('--osx-sign', 'Sign app for OSX (requires OSX host platform)')
